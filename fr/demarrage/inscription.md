...
1. Rendez-vous sur [pitstoply.ch](https://pitstoply.ch)
...
### Étape 3 : Confirmer votre email

1. Vérifiez votre boîte de réception
2. Ouvrez l'email de PitStoply
...
1. Allez sur [app.pitstoply.ch](https://app.pitstoply.ch)
2. Entrez votre email et mot de passe
3. Cliquez sur **Se connecter**

### Assistant de configuration

À votre première connexion, un assistant vous guide pour :

1. **Informations entreprise** - Nom, adresse, contact
2. **Succursales et lifts** - Vos lieux et postes de travail
3. **Services** - Types de prestations proposées
4. **Notifications** - Configuration email/SMS
