...
3. Consultez votre boîte de réception (et les spams !)
4. Cliquez sur le lien dans l'email reçu
5. Définissez un nouveau mot de passe

{% hint style="warning" %}
Le lien de réinitialisation expire après 60 minutes. Si vous ne l'utilisez pas à temps, demandez-en un nouveau.
{% endhint %}
...
Si vous voyez un message indiquant que votre compte est bloqué :
...
1. Vérifiez vos emails précédents de PitStoply
...
Ce message apparaît si vous êtes resté inactif trop longtemps.
